...
class Player(pygame.sprite.Sprite):
	...
	def shoot(self):
		...
		if power<=3:
			...
			#bullets.add(angb3)
			#q3+=0.5
			bullet1=Bullet(self.rect.center,self.rect.top,10-abs(rsp),-rsp)
			all_sprites.add(bullet1)
			bullets.add(bullet1)
			bullet2=Bullet(self.rect.center,self.rect.top,10-abs(rsp),rsp)
			all_sprites.add(bullet2)
			bullets.add(bullet2)
	...
	def boom(self):
		...
		if now-bombtime>500 and bombs!=0:
			...
			for b in bossbullets:
				...
				angbtrap=Specialbullet(b.rect.x,b.rect.y,self.rect.x,self.rect.y,-10-abs(b.speed),3,0)
			...
			for i in bullets:
				...
				#all_sprites.add(angb2)
				#bullets.add(angb2)
				angb3=Specialbullet(i.rect.x,i.rect.y,self.rect.x,self.rect.y,-10-abs(i.speed),3,0)
				all_sprites.add(angb3)
				bullets.add(angb3)
